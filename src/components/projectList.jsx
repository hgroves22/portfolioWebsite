...
const projectList = [
  ...
  },
  {
    ...
    side: "left",
    summary: "A fully functional management system written in C++ that enables users to send custom-designed robots to clean simulated rooms through a Command Line Interface (CLI). Throughout this four-month project, my team applied the Scrum framework to practice effective Agile development. This project was developed by me and three classmates in the fall of 2023 as part of our Software Engineering elective. We also used  GitHub to collaborate with student developers and resolve 90+ distinct issues.",
  },
  {
    id: id++,
    title: "Computer Design in Logisim",
    link: "something",
